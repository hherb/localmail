...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::commands::admin::daemon::get_admin_daemon_cmd,
            crate::commands::admin::daemon::lifecycle_admin_daemon_cmd,
            crate::commands::admin::daemon::reload_admin_daemon_cmd,
            crate::commands::admin::daemon::restart_account_sync_cmd,
