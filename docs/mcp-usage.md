...
| `list_messages` | `account_ids`, `folder_ids`, `limit`, `cursor` | Keyset date-ordered browse (newest first) when you want recent mail with no filters at all — "show me recent mail". |
